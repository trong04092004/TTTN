...
import vn.tronghm.jobhunter.domain.request.ReqLoginDTO;
import vn.tronghm.jobhunter.domain.response.ResCreateUserDTO;
import vn.tronghm.jobhunter.domain.response.ResLoginDTO;
import vn.tronghm.jobhunter.repository.RoleRepository;
import vn.tronghm.jobhunter.service.UserService;
...
public class AuthController {
  ...
  @Value("${tronghm.jwt.refresh-token-validity-in-seconds}")
  ...
  public ResponseEntity<ResCreateUserDTO> register(@Valid @RequestBody User postManUser) throws IdInvalidException {
    ...
    // Self-registration always gets the default USER (candidate) role
