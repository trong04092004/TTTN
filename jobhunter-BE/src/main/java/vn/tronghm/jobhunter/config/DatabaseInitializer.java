...
import vn.tronghm.jobhunter.repository.PermissionRepository;
import vn.tronghm.jobhunter.repository.RoleRepository;
...
public class DatabaseInitializer implements CommandLineRunner {
  ...
  private final vn.tronghm.jobhunter.repository.CompanyRepository companyRepository;
  ...
  public DatabaseInitializer(
      ...
      vn.tronghm.jobhunter.repository.CompanyRepository companyRepository) {
  ...
  public void run(String... args) throws Exception {
    ...
    if (countPermissions == 0) {
      ...
      arr.add(new Permission("Get current user's subscriber skills", "/api/v1/subscribers/skills", "POST", "SUBSCRIBERS"));

      arr.add(new Permission("Download a file", "/api/v1/files", "POST", "FILES"));
      arr.add(new Permission("Upload a file", "/api/v1/files", "GET", "FILES"));

      arr.add(new Permission("Get notifications with pagination", "/api/v1/notifications", "GET", "NOTIFICATIONS"));
      arr.add(new Permission("Update a notification", "/api/v1/notifications/{id}", "PUT", "NOTIFICATIONS"));
